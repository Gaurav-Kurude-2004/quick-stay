...
const AllRooms = () => {
    ...
    //function to check iff a room matches the selected price ranges
    ...
    //function to sort rooms based on the sort option
    const sortRooms = (a,b)=>{
    ...
    const filterDestination = (rooms) =>{
        ...
        return rooms.hotel.city.toLowerCase().includes(destination.toLocaleLowerCase())
    }

    //filter and sort rooms based on the selected filters
                ...
                <div key={room._id} className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-30 last:border-0'>
                    ...
                    <div className='md:w-1/2 flex flex-col gap-2'>
                        ...
                        <div className='flex flex-wrap items-center mt-3 mb-6 gap-4'>
                            {room.amenties && room.amenties.map((item, index)=>(
